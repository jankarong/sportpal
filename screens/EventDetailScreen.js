  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.primary }]}>
        ...
        />
        <Text variant="headlineSmall" style={{ color: theme.colors.onPrimary }}>Detail</Text>
          ...
          <View style={[styles.infoRow, { borderBottomColor: theme.colors.surfaceVariant }]}>
            ...
            <View style={styles.infoTextContainer}>
              <View>
                ...
                <Text variant="bodyMedium" style={[styles.subText, { color: theme.colors.onSurfaceVariant }]}>{event.time}</Text>
              </View>
            </View>
          </View>
